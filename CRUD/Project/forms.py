...
class FormularioUsuario(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'cargo': forms.Select(
				choices=[('','SELECCIONA UNA OPCIÓN'), ('ADMINISTRADOR', 'ADMINISTRADOR'), ('ALMACENISTA', 'ALMACENISTA'), ('ATENCION AL CLIENTE', 'ATENCION AL CLIENTE'), ('CLIENTE', 'CLIENTE')],
				attrs = {
					'class': 'form-control'
				}
			)
...
class PacienteForm(forms.ModelForm):
	class Meta:
		model = Paciente
		fields = ['tipo_cedula_pac','cedula_pac','nombre_pac', 'apellido_pac', 'tipo_telefono_pac', 'telefono_pac', 'id_zona', 'sexo_pac', 'embarazada', 'fecha_nacimiento_pac', 'cod_repr', 'constancia_residencia']
		label = {
			'tipo_cedula_pac': '',
			'cedula_pac': 'Cedula',
			'nombre_pac': 'Nombre',
		...
		widgets = {
			...
			'tipo_telefono_pac': forms.Select(
				choices=[('','SELECCIONA UNA OPCIÓN'), ('0412-', '0412-'), ('0412-', '0412-'), ('0414-', '0414-'), ('0416-', '0416-'), ('0424-', '0424-'), ('0426-', '0426-')],
				attrs = {
					'class': 'form-control'
				}
			),
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['constancia_residencia'].required = False
